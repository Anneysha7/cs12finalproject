# paste version 2 here (tkinter version)
...
# set up the music
mixer.init()
sound1 = 'C:/Users\Dell/OneDrive/Desktop/code/python/PROJECT/Sands of Mystery.mp3'
sound2 = 'C:/Users\Dell/OneDrive/Desktop/code/python/PROJECT/Sands of Mystery.mp3'
queue = [sound1, sound2]
song_index = 0
...
spaceImage1 = Image.open(
    'C:/Users/Dell/OneDrive/Desktop/code/python/PROJECT/sunset-scene-vector.jpg'
)
spaceImage1 = spaceImage1.resize((1280, 720), Image.ANTIALIAS)
resized1 = ImageTk.PhotoImage(spaceImage1)

spaceImage2 = Image.open(
    'C:/Users/Dell/OneDrive/Desktop/code/python/PROJECT/sunset-scene-vector.jpg'
)
...
levelText = tk.Label(topFrame,
                     text='Level ',
                     font=('bangers', 18, 'bold'),
                     foreground='#00cca3',
                     bg='white')
levelText.pack(side='left')

levelDigit = tk.Label(topFrame,
                      text='0',
                      font=('bangers', 18, 'bold'),
                      foreground='#00cca3',
                      bg='white')
...
highScoreDigit = tk.Label(topFrame,
                          text='0',
                          font=('bangers', 18, 'bold'),
                          foreground='#00cca3',
                          bg='white')
...
highScoreText = tk.Label(topFrame,
                         text=' High Score ',
                         font=('bangers', 18, 'bold'),
                         foreground='#00cca3',
                         bg='white')
...
topLevelDigit = tk.Label(topFrame,
                         text='0',
                         font=('bangers', 18, 'bold'),
                         foreground='#00cca3',
                         bg='white')
...
topLevelText = tk.Label(topFrame,
                        text='Top Level ',
                        font=('bangers', 18, 'bold'),
                        foreground='#00cca3',
                        bg='white')
...
head.penup()
head.goto(0,
          0)  # by default we already at 0,0 but we use this for good practice
...
while True:
    ...
    if head.xcor() > 310 or head.xcor() < -310 or head.ycor(
    ...
    if head.distance(
            food
    ) < 30:  # distance is a built in function to measure distance between two turtles
